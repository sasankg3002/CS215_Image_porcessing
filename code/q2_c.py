...
Original file is located at
    https://colab.research.google.com/drive/1WuxqnRV7se8a7-0Cirt6Q6zW4xiklPge
"""
...
plt.title('boxplot of error in C vs log(N)')
plt.show()